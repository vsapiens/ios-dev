...
class FourthTableTableViewController: UITableViewController {
    ...
    @IBAction func oprimioBack(_ sender: Any) {
    ...
    */
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        ...
        let vistaDetalle = segue.destination as! FifthViewController
        
        let indexPath = tableView.indexPathForSelectedRow!
        vistaDetalle.text = listaDatos[indexPath.row] + " " + datoLogin
    }
